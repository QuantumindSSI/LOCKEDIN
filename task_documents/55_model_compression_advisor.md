# Task Template: Model Compression Advisor

## Overview
Optimizing SLMs for specific hardware constraints

## What To Do

### Objective
Recommend model compression strategies for edge deployment

### Data Requirements
- **Data Sources**: Model compression literature, hardware specifications, compression benchmarks
- **Data Format**: JSON with model_specification, hardware_constraints, compression_strategy, expected_performance
- **Data Volume**: 15,000+ compression examples
- **Privacy Considerations**: Public model data

### Implementation Steps
1. Collect and preprocess training data from Model compression literature, hardware specifications, compression benchmarks
2. Set up base model from Hugging Face (see section below)
3. Configure fine-tuning parameters for Model Compression Advisor
...
!lm-evaluation --model hf --model_args pretrained=./results --tasks Model Compression Advisor --device cuda
```
...
### Success Criteria
- **Baseline Performance**: Compression efficiency > 60%
- **Edge Compatibility**: Latency < 2srecommendation, Memory < 3GB
- **Task Accuracy**: Efficiency > 75%
...
- 55_model_compression_advisor
---

# Model Card for 55_model_compression_advisor
...
## Citation
```bibtex
@misc{55_model_compression_advisor,
  title={55_model_compression_advisor},
  author={QuantumIndSSI Ltd},
  year={2026},
  publisher={Hugging Face},
  howpublished={\url{https://huggingface.co/[USERNAME]/55_model_compression_advisor}}
}
```
```
...
# Create repository
api.create_repo(
    repo_id="quantumindssi/55_model_compression_advisor",
    repo_type="model",
...
### 5. Upload via CLI
```bash
huggingface-cli repo create quantumindssi/55_model_compression_advisor --type model
huggingface-cli upload quantumindssi/55_model_compression_advisor ./results/checkpoint-final
```
...
# Then upload
huggingface-cli upload quantumindssi/55_model_compression_advisor README.md
```
...
git init
git add .
git commit -m "Initial commit: 55_model_compression_advisor fine-tuning"
git remote add origin https://github.com/quantumindssi/55_model_compression_advisor
...
st.title("55_model_compression_advisor Demo")
st.sidebar.write("Model: quantumindssi/55_model_compression_advisor")

pipe = pipeline("text-generation", model="quantumindssi/55_model_compression_advisor")
...
```bash
# Create Space
huggingface-cli space new quantumindssi-55_model_compression_advisor-demo --sdk streamlit

# Deploy demo
cd quantumindssi-55_model_compression_advisor-demo
...
#### Tutorial Series
1. "Getting Started with 55_model_compression_advisor"
...
## Model Authors
- 55_model_compression_advisor: @[author]
- 55_model_compression_advisor: @[author]
```
