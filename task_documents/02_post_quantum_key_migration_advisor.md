# Task Template: Post-Quantum Key Migration Advisor

## Overview
Guides organizations through transitioning from classical to quantum-safe cryptography

## What To Do

### Objective
Fine-tune SLM to provide step-by-step migration guidance for cryptographic systems

### Data Requirements
- **Data Sources**: NIST migration guidelines, industry case studies, cryptographic standards documentation
- **Data Format**: JSON with migration_scenarios, current_crypto_stack, target_pqc_schemes, migration_steps
- **Data Volume**: 5,000+ migration scenarios
- **Privacy Considerations**: Synthetic organizational data

### Implementation Steps
1. Collect and preprocess training data from NIST migration guidelines, industry case studies, cryptographic standards documentation
2. Set up base model from Hugging Face (see section below)
3. Configure fine-tuning parameters for Post-Quantum Key Migration Advisor
...
!lm-evaluation --model hf --model_args pretrained=./results --tasks Post-Quantum Key Migration Advisor --device cuda
```
...
### Success Criteria
- **Baseline Performance**: Migration plan completeness > 80%
- **Edge Compatibility**: Latency < 1smigration plan, Memory < 4GB
- **Task Accuracy**: 85% valid migration steps
- **Human Preference**: >70% manual planning preference over baseline
...
- 02_post_quantum_key_migration_advisor
---

# Model Card for 02_post_quantum_key_migration_advisor
...
## Citation
```bibtex
@misc{02_post_quantum_key_migration_advisor,
  title={02_post_quantum_key_migration_advisor},
  author={QuantumIndSSI Ltd},
  year={2026},
  publisher={Hugging Face},
  howpublished={\url{https://huggingface.co/[USERNAME]/02_post_quantum_key_migration_advisor}}
}
```
```
...
### 5. Upload via CLI
```bash
huggingface-cli repo create quantumindssi/02_post_quantum_key_migration_advisor --type model
huggingface-cli upload quantumindssi/02_post_quantum_key_migration_advisor ./results/checkpoint-final
```
...
# Then upload
huggingface-cli upload quantumindssi/02_post_quantum_key_migration_advisor README.md
```
...
git init
git add .
git commit -m "Initial commit: 02_post_quantum_key_migration_advisor fine-tuning"
git remote add origin https://github.com/quantumindssi/02_post_quantum_key_migration_advisor
...
st.title("02_post_quantum_key_migration_advisor Demo")
st.sidebar.write("Model: quantumindssi/02_post_quantum_key_migration_advisor")

pipe = pipeline("text-generation", model="quantumindssi/02_post_quantum_key_migration_advisor")
...
```bash
# Create Space
huggingface-cli space new quantumindssi-02_post_quantum_key_migration_advisor-demo --sdk streamlit

# Deploy demo
cd quantumindssi-02_post_quantum_key_migration_advisor-demo
...
#### Tutorial Series
1. "Getting Started with 02_post_quantum_key_migration_advisor"
...
## Model Authors
- 02_post_quantum_key_migration_advisor: @[author]
- 02_post_quantum_key_migration_advisor: @[author]
```
